                    ...
                    double** displacements, int* n_nodes, double* frequencies)
{
    ...
    designMultipleTuningFork(handle_length, base_prongs_length, space_between_base_branch,
     space_between_second_layer, second_prongs_length, meshSizeFactor, outGEO);
                    ...
                    double** displacements, int* n_nodes, double* frequencies)
{
    ...
    designTuningFork(r1, r2, e, l, meshSizeFactor, outGEO);
